...
export function guessUpdater() {
  ...
  function guess() {
    ...
    const passGuesses = document.querySelector('#pastGuesses');
    const scoreTextW = document.querySelector('#scoreW');
    const scoreTextL = document.querySelector('#scoreL');
    ...
    const GUESSESLAST = GUESSES[GUESSES.length - 1];
